...
public class OutgoingReceiptsModel {
    ...
    private ArrayList<OutgoingReceiptsListAdapter.InvoiceModel> invoiceList;
    ...
    public ArrayList<OutgoingReceiptsListAdapter.InvoiceModel> getInvoiceList() {
        return invoiceList;
    }

    public void setInvoiceList(ArrayList<OutgoingReceiptsListAdapter.InvoiceModel> invoiceList) {
