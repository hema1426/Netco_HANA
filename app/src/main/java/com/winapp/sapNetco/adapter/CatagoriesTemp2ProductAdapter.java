...
import static com.winapp.sapNetco.fragments.CategoriesTemp2TabFragments.sharedPreferenceUtil;
...
public class CatagoriesTemp2ProductAdapter extends RecyclerView.Adapter {
    ...
    public CatagoriesTemp2ProductAdapter(Context context, ArrayList<ProductsModel> productsList, CallBack callBack) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_FOOTER) {
            ...
            itemView = View.inflate(parent.getContext(), R.layout.catagories_temp2_items, null);
                                    ...
                                    if (isAllowLowStock) {
                                        ...
                                        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
                                            ...
                                            if (mContext instanceof MainHomeActivity) {
                                                ...
                                                callBack.showBottomDescription(object);

//                                        Intent intent = new Intent(mContext, DescriptionActivityToDialog.class);
...
//                                        mContext.startActivity(intent);
    ...
    public class ElementsViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView thumbnail, addCart_catImgl;
    ...
    public interface CallBack {
        ...
        void showBottomDescription(String model);
