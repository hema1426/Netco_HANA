...
public class OutgoingReceiptsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<OutgoingReceiptsModel> receiptsList;
    Context mContext;
    CallBack callBack;
    public static ArrayList<OutgoingReceiptsModel> receiptsFilterList;
    private String companyId;
    private SessionManager session;
    private HashMap<String, String> user;
    private ArrayList<InvoiceModel> receiptInvoiceList;

    public OutgoingReceiptsListAdapter(Context context, RecyclerView mRecyclerView,
                                       ArrayList<OutgoingReceiptsModel> receiptsList, CallBack callBack) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.outgoing_list_items, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder  viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        try {
            ...
            if ( viewHolder instanceof ReceiptsViewHolder) {
                OutgoingReceiptsModel receiptsModel = receiptsList.get(position);
                ...
                if(receiptsModel.getReferenceNo() != null || !receiptsModel.getReferenceNo().isEmpty()){
                    ((ReceiptsViewHolder) viewHolder).reference_nol.setText(receiptsModel.getReferenceNo());
                    ((ReceiptsViewHolder) viewHolder).referenceNo_lay.setVisibility(View.VISIBLE);
                }else{
                    ((ReceiptsViewHolder) viewHolder).referenceNo_lay.setVisibility(View.GONE);
                }
  ...
  /*  @Override
    ...
    private ArrayList<InvoiceModel> getReceiptsDetails(String receiptNumber,@NonNull RecyclerView.ViewHolder  viewHolder, int position,OutgoingReceiptsModel receiptsModel) throws JSONException {
    ...
    public void setInvoiceAdapter(@NonNull RecyclerView.ViewHolder  viewHolder, int position,ArrayList<InvoiceModel> invoices){
        ...
        OutgoingReceiptInvoiceAdapter adapter=new OutgoingReceiptInvoiceAdapter(mContext,invoices);
    ...
    static class ReceiptsViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView netTotal,reference_nol;
        ...
        private LinearLayout mainLayout,referenceNo_lay;
        ...
        public ReceiptsViewHolder(View view) {
            ...
            reference_nol=view.findViewById(R.id.reference_no_outg_item);
            referenceNo_lay=view.findViewById(R.id.refNo_lay_outg_item);
    ...
    public void filterList(ArrayList<OutgoingReceiptsModel> filterdNames) {
        receiptsList = filterdNames;
        notifyDataSetChanged();
    }

    public static ArrayList<OutgoingReceiptsModel> getReceiptsList(){
    ...
    public interface CallBack {
        void calculateNetTotal(ArrayList<OutgoingReceiptsModel> salesList);
        void showMoreOption(String receiptNo,String customerName,String  customerCode,String paymentMode,OutgoingReceiptsModel model);
        void openWhatsapp();
    }

    public void setOrder() {
        try {
            Collections.sort(receiptsList, new Comparator<OutgoingReceiptsModel>() {
                public int compare(OutgoingReceiptsModel obj1, OutgoingReceiptsModel obj2) {
